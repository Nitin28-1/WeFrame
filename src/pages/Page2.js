...
function Page2() {
    ...
    const products = [
      ...
      const progressIcons=[
        ...
        {
            image:"/Groupe_56.png",
            title:"Commande lllimitee",
            desc: "Tout est possible",
        },
        {
            image:"/Groupe_123.png",
            title:"Transport & Enlevement",
  ...
  return (
    ...
    < div className='flex w-full items-center justify-between px-10 mb-10'>
     <n className="text-[18px]  md:text-[25px] font-serif">Articles similaries</n>
    ...
    <div className='flex mb-6'>
     ...
     <n className="text-[0.9rem] sm:text-[22px] md:text-[28px] font-serif">Ces produits pourraient vous intéresser</n>
            ...
            <div className="w-full  px-2 mb-2 flex items-cente justify-between"> 
                ...
                <div className="  px-2 flex justify-between items-center">
                 <p className="text-sm text-gray-400">{data.description}</p>
                  <p className=" text-sm pb-1  bg-[#80808020]  p-1 px-2 rounded-2xl">20 pieces</p>
                </div>
    ...
    <div className=' flex   flex-col items-center  mt-20 pb-10 bg-[#FEF8FB]'>
          ...
          <div className='pt-10 flex flex-col items-center'>
            <p className='text-[24px] sm:text-[30px]'>On s'occupe de <span className='font-bold text-[#5CD2DD]'>tout</span></p>
            <p className='text-[12px] sm:text-[20px] text-[#575656]'>Office ipsum you must be muted. It meeting commitment busy pain.</p>
          </div>
            ...
            progressIcons.map((data,index)=>(
               <>
                <div key={index} className='flex flex-col items-center'>
                 ...
                 {progressIcons.length != index+1 ? (<hr className='hidden md:block md:w-[3rem]'/>) :
                (<></>)}
