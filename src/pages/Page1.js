...
function page1() {
  return (
    <div>
      <div className="my-4 ml-4 text-gray-500">
      ...
      <div className="flex flex-col w-[100%] sm:h-[500px] md:h-[400px] gap-5 sm:gap-2 sm:items-start sm:flex-row md:flex-row items-center lg:h-[500px] lg:justify-around md:justify-between">
        <div className="w-[100%] mr-1 sm:h-[85%] flex justify-center md:none lg:w-[50%] xl:w-[50%] md:w-[40%]">
          <Image
            width={300}
            height={100}
            alt="Cheese appareil image"
            src="/page1image.png"
            className="w-[90%] sm:w-[100%] sm:h-[90%] md:w-[100%] md:h-[340px] lg:w-[90%] lg:h-[95%] object-cover ml-10 rounded-lg"
          />
        </div>
        ...
        <div className="w-[100%] h-[400px] sm:h-[380px] md:h-[85%] flex flex-col items-center md:w-[50%]">
          <div className="w-[80%] h-[83%] md:w-[90%] border-b-2 sm:text-[12px]">
            <div className="flex items-center justify-stretch border-b-2 pb-2">
              <div>
                <h1 className="text-[18px] sm:text-[18px] lg:text-[30px] font-serif md:text-[20px]">
                  Cheese appareil à raclette 1/2 roue
                </h1>
                <n className="text-[15px] sm:text-[15px] md:text-[20px] lg:text-[25px] font-semibold">
                  39,50€ <ni className="font-normal lg:text-[20px] text-gray-600">/pièce</ni>
                </n>
              </div>
              ...
              <div className="flex gap-5">
                <div className="flex gap-2 items-center">
                  <Image
                    width={20}
                    height={100}
                    alt="Dimension icon 20cm"
                    src="/Capa_1.png"
                  />
                  <span>
                    20 <sup className="font-semibold">cm</sup>
                  </span>
                </div>
                ...
                <div className="flex gap-2 items-center">
                  <Image
                    width={20}
                    height={100}
                    alt="Dimension icon 50cm"
                    src="/Frame.png"
                  />
                  <span>
                    50 <sup className="font-semibold">cm</sup>
                  </span>
                </div>
              </div>
          ...
          <div className="flex gap-2 mt-2 md:gap-2">
            <Counter />
            <button className="w-[80%] md:w-[60%] lg:w-[80%] rounded-md bg-[#5CD2DD] text-white">
              AJOUTER AU PANIER
            </button>
          </div>
        </div>
      ...
      <div className="w-[100%] h-[20%] flex md:flex-row flex-col md:mt-0 mt-2 mb-10">
        <div className="w-[85%] md:w-[43.4%] ml-10 flex flex-col gap-3">
          ...
          <n className="text-[#3b3b3b]">
            Festi vous propose à la location un/une &quot;Jewel-grand couteau/10pc pour
            votre évenement et ce dès 0,35 € /pièce (HTVA). Que ce soit pour votre
            mariage, une fête d&apos;anniversaire ou du personnel, ce produit a fait
            l&apos;objet d&apos;une sélection rigoureuse par notre équipe. Il est en
            ...
            soient toujours une réussite. Vous pourrez trouver tout une série d&apos;autre
